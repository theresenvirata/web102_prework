...
function filterUnfundedOnly() {
    ...
    const notMetGoal = GAMES_JSON.filter( (games) => {
...
function filterFundedOnly() {
    ...
    const metGoal = GAMES_JSON.filter( (games) => {
        return games.goal <= games.pledged;
    });
...
let displayStr = `A total of $100,000 has been raised for 11 games. Currently, ${
    unfundedGames > 0
    ? `${unfundedGames} games are unfunded.`
